...
<section class="share-section">
  {#if isOwner}
    <button class="no-fill-button flex-end" on:click={remove}>
  ...
  {:else}
    {#if item.is_booked && isBookedByCurrentUser }
      <button class="no-fill-button flex-end" on:click={unbook}>
    ...
    {:else if item.is_booking_available }
      <button class="no-fill-button flex-end" on:click={book} disabled="{item.is_booked}">
